...
Concepts: REST APIs, JWT Authentication, MVC Architecture, Indexing, Aggregation
...
- Optimized MongoDB queries using indexing and aggregation pipelines, reducing response time by 35%.
- Built authentication and authorization system using JWT and role-based access control.
...
I enjoy working on system design problems and improving system performance. Recently, I have been exploring AI integration in backend applications and learning about scalable backend architecture. I have basic knowledge of Redis and Docker but haven't used them extensively in production.
`;
...
module.exports = getInterviewData